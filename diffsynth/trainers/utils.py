...
def wan_parser():
    ...
    parser.add_argument("--dpo", action="store_true", default=False, help="Use Direct Preference Optimization training.")
    parser.add_argument("--chosen_video_key", type=str, default="chosen", help="Column name for the preferred video in preference data.")
    parser.add_argument("--rejected_video_key", type=str, default="rejected", help="Column name for the rejected video in preference data.")
